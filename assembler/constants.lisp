...
(defconstant +rom0+    #x0000)
(defconstant +rom1+    #x4000)
(defconstant +vram0+   #x8000)
(defconstant +vram1+   #x8800)
(defconstant +vram2+   #x9000)
(defconstant +vram+    +vram0+)
(defconstant +map0+    #x9800)
(defconstant +map1+    #x9c00)
(defconstant +map+     +map0+)
(defconstant +wram0+   #xc000)
(defconstant +wram1+   #xd000)
(defconstant +wram+    +wram0+)
(defconstant +echo+    #xe000)
(defconstant +oam+     #xfe00)
(defconstant +io+      #xff00)
(defconstant +hram+    #xff80)

(defconstant +rom-page-size+   #x4000)
(defconstant +vram-page-size+  #x800)
(defconstant +vram-table-size+ #x1000)
(defconstant +map-page-size+   #x400)
(defconstant +wram-page-size+  #x1000)
